...
/*    current = gyro_bytes[2];
  ...
  */  
    ...
    dutyCycleRight = 5 + initialValue - height_pid + angle_pid;
...
void ultrasonic() {
  ...
  while(1) {
    ...
    if(ult_height > 300) ult_height = 75;
...
int main()                                    // Main function
{
  ...
  while(1)
  {
    ...
    print("EInt:%2.3f, DCR:%2.1f, DCL:%2.1f\n", err_integral, dutyCycleRight, dutyCycleLeft);
    //print("%2.1f\n", ult_height);
    pause(200);
  }  
}
